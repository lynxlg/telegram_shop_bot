...
- [Development Environment](development.md) — как подготовить локальное окружение, поднять PostgreSQL, запустить бота и выполнить test-команды.
...
- [Runbooks](runbooks/README.md) — индекс operational runbooks; пока каталог пуст, кроме индекса.
