...
Каталог `memory-bank/flows/` содержит process-layer этого репозитория: lifecycle rules, taxonomy стабильных идентификаторов и governed templates для project-specific документации.
